		...
		<header class="header">
			<div class="container">
				<div class="header-area">
					<div class="logo">
						<a href="{{route('home')}}"><img src="{{asset('tema')}}/assets/img/logo.png" alt="logo" /></a>
					</div>
					...
					<div class="menu-area">
					    ...
					    <div class="mainmenu">
                            <ul id="primary-menu">
                                <li><a class="@if(Request::segment(1) == '') active @endif" href="{{route('home')}}">Anasayfa</a></li>
                                <li><a class="@if(Request::segment(1) == 'movie') active @endif" href="{{route('movie')}}">Videolar</a></li>
		...
		<div class="login-area">
			<div class="login-box rounded">
				...
				<form action="{{ route('loginPost') }}" method="POST">
					...
					<span>Veya Sosyal Medya Yoluyla</span>
